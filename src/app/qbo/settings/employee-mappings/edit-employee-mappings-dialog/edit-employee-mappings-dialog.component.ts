...
@Component({
  selector: 'app-edit-employee-mappings-dialog',
  templateUrl: './edit-employee-mappings-dialog.component.html',
  styleUrls: ['./edit-employee-mappings-dialog.component.scss', '../../settings.component.scss']
})
export class EditEmployeeMappingsDialogComponent implements OnInit {
  ...
  constructor(private formBuilder: FormBuilder,
    public dialogRef: MatDialogRef<EditEmployeeMappingsDialogComponent>,
  ...
  reset() {
    ...
    forkJoin([
      ...
      that.form = that.formBuilder.group({
        fyleEmployee: that.data.fyleEmployeeValue,
